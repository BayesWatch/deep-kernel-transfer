...
if __name__ == '__main__':
    ...
    if params.method in ['baseline', 'baseline++']:
    ...
    elif params.method in ['gpnet', 'protonet', 'matchingnet', 'relationnet', 'relationnet_softmax', 'maml', 'maml_approx']:
        n_query = max(1, int(
        ...
        if(params.method == 'gpnet'):
            model = GPNet(model_dict[params.model], **train_few_shot_params)
            model.init_summary()          
