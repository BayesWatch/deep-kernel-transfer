...
class MAML(MetaTemplate):
    ...
    def train_loop(self, epoch, train_loader, optimizer, results_logger):  # overwrite parrent function
        print_freq = 10
        avg_loss = 0
        task_count = 0
        loss_all = []
        ...
        for i, (x, _) in enumerate(train_loader):
            ...
            if i % print_freq == 0:
                ...
                results_logger.log("batch_nr", i)
                results_logger.log("avg_loss", avg_loss / float(i + 1))
