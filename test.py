...
def single_test(params):
    ...
    elif params.method == 'gpnet':
        model           = GPNet(model_dict[params.model], **few_shot_params)
    ...
    if params.save_iter != -1:
        ...
        split_str = split
    if params.method in ['maml', 'maml_approx', 'gpnet']: #maml do not support testing with feature
